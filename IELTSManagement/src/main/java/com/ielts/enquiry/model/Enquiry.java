...
public class Enquiry {
    ...
    public Enquiry(long id, String name, String contact, String emailid, String date, Address address, Course course, String sourceOfInfo, String mode, String interestStatus, String enquiryStatus, int priority, List<FollowUp> followUps) {
        this.id = id;
        this.name = name;
